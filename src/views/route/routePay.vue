            ...
            <div class="content-order-details">
                <div class="content-order-details-left" v-show="orderShow">
                    ...
                    <dl class="dl-horizontal">
                        ...
                        <dd>在三亚，如果你有伴儿，三亚将满足你对一场饱含山盟海誓的恋爱的全部幻想；如果你是一个人，三亚也不会让你得空去嗟叹，你可以在亚洲潜水圣地蜈支洲岛海湾零距离观赏珊瑚礁，可以去热带雨...</dd>
                    </dl>
...
export default {
    ...
    computed: {
        ...
        ...mapGetters("rule",["orderPrice"]),
        ...mapState("rule",["orderid"])
    },
    components: {
        ezHeader,
        ezContainer,
        ...
        async payOrder() {
            if(await payOrder({
                ...
                this.successMsg('支付成功',()=>{
                       this.$router.push({path:"/routeSuccess"})
                });
            }
        },
        //订单详情
