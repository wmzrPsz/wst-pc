    ...
    <div class="content  ez-travel-payment main_content">
      <div class="content-order">
        ...
        <div class="content-order-details">
          <div class="content-order-details-left" v-show="orderShow">
            ...
            <div class="content-order-details-basis-info">
              ...
              <p>
                订单编号:
                <br>R13214129482103210
              </p>
              <p>
                下单时间:
                <br>2018-02-22 18:10:16
              </p>
            </div>
            ...
            <dl class="dl-horizontal">
              ...
              <dd>
                在三亚，如果你有伴儿，三亚将满足你对一场饱含山盟海誓的恋爱的全部幻想；如果你是一个人，三亚也不会让你得空去嗟
                叹，你可以在亚洲潜水圣地蜈支洲岛海湾零距离观赏珊瑚礁，可以去热带雨...
              </dd>
            </dl>
            ...
            <h4 class="content-order-details-price-sun">
              总计金额
              <b>{{currencySign}}122,780</b>
            </h4>
          </div>
        ...
        <div class="content-order-details-pay">
          ...
          <span>
            应付金额
            <b>{{currencySign}}{{orderPrice}}</b>
          </span>

          <div class="content-order-details-pay-way">
            <div
              :class="payType==list.id?'content-order-details-pay-way-style':''"
              @click="payTypeClick(list.id)"
              v-for="(list, index) in payTypeList"
              :key="index"
            >
              <i></i>
              <span>{{list.name}}</span>
...
export default {
  ...
  data() {
    ...
    computed: {
        ...
        ...mapGetters("sopt",["orderPrice"]),
        ...mapState("sopt",["orderid"])
    },
  components: {
    ezHeader,
    ezContainer,
