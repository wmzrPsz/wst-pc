    ...
    <div>
        ...
        <div class="ez-place-city">
            ...
            <div class="place-city-text pull-right">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                    <router-link class="btn btn-post-warning" tag="a" :to="{path:`/city/addStrategy/${cityid}`}">发表游记</router-link>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12 ez-index-wrap ez-search-result">
            ...
            <div class="box-left pull-left">
                <router-link :to="{path: `/route/routeInfo/${list.id}`}"
                class="box-card" v-for="(list, index) in offeredList" :key="index">
        ...
        <section class="col-md-12 ez-index-wrap place-wrap-travel">
            ...
            <div class="ez-row">
                ...
                <router-link :to="{path: `/sopt/soptInfo/${list.id}`}" tag="div"
                class="col-md-3 col-sm-3 col-xs-3 ez-index-grid" 
                v-for="(list, index) in scenicSpotList" :key="index">
                    <div class="grid-img">
            ...
            <div class="ez-nav-tabs ez-nav-item4">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane ez-row active">
                        ...
                        <router-link :to="{path:`/game/gameInfo/${list.id}`}" tag="div" 
                        class="col-md-3 col-sm-3 col-xs-3 ez-hot-card" v-for="(list, index) in playList" :key="index">
        ...
        <section class="col-md-12 ez-index-wrap ez-city-commun">
                ...
                <div class="ez-nav-tabs ez-nav-item pull-left">
                    ...
                    <div class="tab-content tab-content-place pull-left">
                        ...
                        <div class="tab-pane active">
                            <router-link :to="{path:`/city/strategyInfo/${list.id}`}" tag="a"
                            class="box-card box-card-game" v-for="(list, index) in strategyList" :key="index">
            ...
            <div class="box-right pull-right">
                <div class="place-group-btn text-center">
                    <router-link class="btn btn-lg pull-left"  tag="a" :to="{path:`/city/addCityComment/${cityid}`}">评价城市</router-link>
                    <router-link class="btn btn-lg pull-right active"  tag="a" :to="{path:`/city/addStrategy/${cityid}`}">发表游记</router-link>
                </div>
